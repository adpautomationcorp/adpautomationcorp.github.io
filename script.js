document.addEventListener('DOMContentLoaded', function() {
    ...
    function translateToSpanish() {
        ...
        const translations = {
            ...
            'We are based in New Windsor, NY and serve the Hudson Valley across Orange, Ulster, Dutchess, Sullivan, and Putnam counties, including Newburgh, Poughkeepsie, Middletown, Kingston, Beacon, Monticello, and Carmel. For projects farther out across New York and neighboring states, contact us and we will let you know if we can help.': 'Estamos ubicados en New Windsor, NY y atendemos el Valle del Hudson en los condados de Orange, Ulster, Dutchess, Sullivan y Putnam, incluidas ciudades como Newburgh, Poughkeepsie, Middletown, Kingston, Beacon, Monticello y Carmel. Para proyectos más lejanos en Nueva York y estados vecinos, contáctenos y le informaremos si podemos ayudar.',
            ...
            'We work on industrial and municipal systems, including water and wastewater treatment controls, pump, lift, and booster stations, industrial motor controls and VFDs, instrumentation and calibration, and custom control panels.': 'Trabajamos en sistemas industriales y municipales, incluidos controles de tratamiento de agua y aguas residuales, estaciones de bombeo, elevación y presión, controles de motores industriales y VFD, instrumentación y calibración, y paneles de control personalizados.',
            'Do you service municipal water and wastewater systems?': '¿Dan servicio a sistemas municipales de agua y aguas residuales?',
            'Yes. We work with town, village, and district water and sewer systems on pump stations, lift stations, booster stations, wet well controls, tank and reservoir levels, and SCADA telemetry, with 24/7 emergency support to keep them online.': 'Sí. Trabajamos con sistemas de agua y alcantarillado de pueblos, aldeas y distritos en estaciones de bombeo, estaciones de elevación, estaciones elevadoras de presión, controles de pozo húmedo, niveles de tanques y reservorios, y telemetría SCADA, con soporte de emergencia 24/7 para mantenerlos en funcionamiento.',
